...
ttk.Button(btn_frame, text="Encrypt (message)", command=ask_and_encrypt).grid(row=0, column=0, padx=8, pady=6)
ttk.Button(btn_frame, text="Decrypt (message)", command=ask_and_decrypt).grid(row=0, column=1, padx=8, pady=6)
ttk.Button(btn_frame, text="Encrypt File", command=encrypt_file_from_entry).grid(row=1, column=0, padx=8, pady=6)
ttk.Button(btn_frame, text="Decrypt File", command=decrypt_file_from_entry).grid(row=1, column=1, padx=8, pady=6)
